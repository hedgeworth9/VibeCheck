...
class PropertyForm(forms.ModelForm):
	class Meta:
		...
		widgets = {
			...
			'price': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'building_age': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'building_codes': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'fault_line': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'retrofitted': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'foundation_issues': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'soil': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'building_height': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'building_insurance': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'disaster_history': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'fire_exits': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'gas_valve': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'evacuation_zone': forms.RadioSelect(attrs={'class': 'property-form-radio'}),
			'essential_institutions': forms.RadioSelect(attrs={'class': 'property-form-radio'})
		}
